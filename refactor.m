...
%% 验证数据
table_x_v = readtable('data_x_v.csv');
table_y_v = readtable('data_y_v.csv');
%验证数据
...
save('result_display.mat', 'data_y_v', 'data_y_p', 'errors', 'errors_percentage');
